  ...
  data() {
    return {
      ...
      formData: {
        ...
        edit_type: 10,
        html_content:
          '<pre><code class="lang-">function hello() {↵  console.log(1);↵}↵</code></pre>↵',
        is_english: 0,
        is_gfw: 0,
        is_original: 1,
        link_url: "",
        mark_content: "```\nconsole.log(1);\n```",
        tag_ids: ["6809637769959178254", "6809637767543259144"],
        title: "测试啊",
      },
    };
  },
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          this.formData.mark_content = JSON.stringify(
            this.formData.mark_content
          );
